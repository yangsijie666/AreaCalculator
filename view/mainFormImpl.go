...
func (f *TMainForm) OnFormCreate(sender vcl.IObject) {
    ...
    f.DisplayMemo.Lines().SetText(logic.MyDisplay.DisplayResult(mytypes.DisplayUnitDefault))
    ...
    f.HistoryMemo.SetHeight(288)
    f.HistoryMemo.SetWidth(272)
    f.HistoryMemo.SetLeft(390)
    f.HistoryMemo.SetTop(10)
    f.HistoryMemo.Lines().SetText(logic.MyHistoryDisplay.Display(mytypes.DisplayUnitDefault))
    ...
    f.DisplayUnitComboBox.SetTabOrder(7)
...
func (f *TMainForm) OnDisplayUnitComboBoxSelect(sender vcl.IObject)  {
    ...
    f.DisplayMemo.Lines().SetText(logic.MyDisplay.DisplayResult(displayUnit))
    f.HistoryMemo.Lines().SetText(logic.MyHistoryDisplay.Display(displayUnit))
}
...
func (f *TMainForm) OnClearSpeedButtonClick(sender vcl.IObject) {
    ...
    case mytypes.AllClearCaption:
        // 全部复位
        logic.MyDisplay = models.NewDisplay()
        logic.MyHistoryDisplay = models.NewHistoryDisplay()
        f.DisplayMemo.Lines().SetText(logic.MyDisplay.DisplayResult(mytypes.DisplayUnitDefault))
        f.HistoryMemo.Lines().SetText(logic.MyHistoryDisplay.Display(mytypes.DisplayUnitDefault))

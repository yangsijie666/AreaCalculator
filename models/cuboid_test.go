...
func TestNewCubes(t *testing.T) {
    c := NewCuboids(decimal.NewFromInt(5), types.M, decimal.NewFromInt(2), types.CM, decimal.NewFromInt(3), types.DM, 1)
...
func TestCuboids_Display(t *testing.T) {
    c := NewCuboids(decimal.NewFromInt(0), types.M, decimal.NewFromInt(0), types.CM, decimal.NewFromInt(0), types.DM, 0)
